...
cd ANYKERNEL/
rm *.zip
zip -r9 jsX-RN8_8T-4.14.202-Ginkgo-Vikingo-Caf_rV0.1+Wed-October-28-2020.zip * -x .git README.md *placeholder
cp jsX-RN8_8T-4.14.202-Ginkgo-Vikingo-Caf_rV0.1+Wed-October-28-2020.zip /home/javashin/Desktop/
ls -lash jsX-RN8_8T-4.14.202-Ginkgo-Vikingo-Caf_rV0.1+Wed-October-28-2020.zip ; pwd ; cd .. ; pwd
